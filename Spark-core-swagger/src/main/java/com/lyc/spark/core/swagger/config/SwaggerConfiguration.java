package com.lyc.spark.core.swagger.config;

import com.lyc.spark.core.swagger.properties.SparkCoreSwaggerProperties;
...
//import springfox.validators.configuration.BeanValidatorPluginsConfiguration;
...
@EnableConfigurationProperties(SparkCoreSwaggerProperties.class)
@ConditionalOnProperty(value = SparkCoreSwaggerProperties.PREFIX_KEY + ".enable", havingValue = "true", matchIfMissing = true)
public class SwaggerConfiguration implements WebMvcConfigurer {

	private final SparkCoreSwaggerProperties swaggerProperties;
...
//	@Bean
	...
	public Docket createRestApi() {
		System.out.println("swagger --- 初始化");
